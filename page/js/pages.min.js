! function($) {
    "use strict";
    var Pages = function() {
        this.VERSION = "1.0.0", this.AUTHOR = "Revox", this.SUPPORT = "support@revox.io", this.pageScrollElement = "html, body", this.$body = $("body"), this.setUserOS(), this.setUserAgent()
    };
...
function(window) {
    ...
    function offset(obj) {
        var curleft, curtop;
        if (curleft = curtop = 0, obj.offsetParent) {
    ...
    SelectFx.prototype.options = {
        ...
        if (this._isOpen()) {
            ...
            console.log("cs-placeholder: " + csPlaceholderWidth), console.log("cs-options: " + csOptionsWidth), this.selEl.style.width = resizedWidth + "px", this.selEl.style.height = originalHeight + "px", csOptions.style.width = "100%", setTimeout(function() {
        ...
        oldOpt && classie.remove(oldOpt, "cs-selected"), classie.add(opt, "cs-selected"), opt.getAttribute("data-link") && (this.options.newTab ? window.open(opt.getAttribute("data-link"), "_blank") : window.location = opt.getAttribute("data-link")), this.options.onChange(this.el.value)
...
function($) {
    ...
    var Portlet = function(element, options) {
        this.$element = $(element), this.options = $.extend(!0, {}, $.fn.portlet.defaults, options), this.$loader = null, this.$body = this.$element.find(".panel-body"), this.$loaderSVG = this.$loaderSVG || $('<img src="pages/img/progress/progress-' + this.options.progress + "-" + this.options.progressColor + '.svg" style="display:none">').appendTo(this.$element)
    };
...
function($) {
    ...
    var Quickview = function(element, options) {
        function slide(side, callback) {
            var op1, op2;
            op1 = "left" == side ? (op2 = "closed") && "open" : (op2 = "open") && "closed", $(_this.options.notesList).removeClass(op1).addClass(op2), $(_this.options.notesBody).removeClass(op2).addClass(op1), $(_this.options.notes + " > .inner").toggleClass("slided"), "undefined" != typeof callback && callback()
        }
        this.$element = $(element), this.options = $.extend(!0, {}, $.fn.quickview.defaults, options), this.bezierEasing = [.05, .74, .27, .99];
        var _this = this;
        $(this.options.notes).on("click", ".list > ul > li", function() {
            ...
            e.stopPropagation()
        }), $(this.options.notes).on("click", ".close-note-link", function() {
            slide("right")
        }), $(".delete-note-link").click(function(e) {
            e.preventDefault(), $(this).toggleClass("selected"), $(_this.options.notes).find(".list > ul > li .checkbox").fadeToggle("fast"), $(".btn-remove-notes").fadeToggle("fast").removeClass("hide")
        }), $(".new-note-link").click(function(e) {
            e.preventDefault(), slide("left", function() {
    ...
    $.fn.quickview = Plugin, $.fn.quickview.Constructor = Quickview, $.fn.quickview.defaults = {
        ...
        if (Modernizr.csstransitions) $(elem).toggleClass("open");
        else {
...
function($) {
    ...
    Search.VERSION = "1.0.0", Search.prototype.init = function() {
        ...
        this.pressedKeys = [], this.ignoredKeys = [], this.$searchField = this.$element.find(this.options.searchField), this.$closeButton = this.$element.find(this.options.closeButton), this.$suggestions = this.$element.find(this.options.suggestions), this.$brand = this.$element.find(this.options.brand), this.$searchField.on("keyup", function() {
            ...
            return _this.options.onKeyEnter(_this.$searchField.val()), 13 == e.keyCode && (e.preventDefault(), _this.options.onSearchSubmit(_this.$searchField.val())), $("body").hasClass("overlay-disabled") ? 0 : void 0
        ...
        $("body").hasClass("overlay-disabled") || $(e.target).hasClass("js-input") || "INPUT" == nodeName || "TEXTAREA" == nodeName || 0 === e.which || 0 === e.charCode || e.ctrlKey || e.metaKey || e.altKey || this.toggleOverlay("show", String.fromCharCode(e.keyCode | e.charCode))
